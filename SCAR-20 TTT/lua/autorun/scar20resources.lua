...
resource.AddFile("gamemodes/terrortown/content/materials/VGUI/ttt/scar-20.vmt")
resource.AddFile("gamemodes/terrortown/entities/weapons/weapon_ttt_scar20/shared.lua")
